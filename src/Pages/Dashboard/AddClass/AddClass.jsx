...
//     const onSubmit = data => {
//         console.log(data);
//         const {name,instructorName,instructorEmail,photo,availableSeats,price}=data;

//         const newClass={name,instructorName,instructorEmail,photo,availableSeats,student:0,price};
  ...
  return (
    <div className='w-full px-20'>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <input type="submit" className='btn btn-warning my-4 w-full' value="Add Class" />
      </form>
